...
RUN adduser -l -u 33333 -G sudo -md /home/gitpod -s /bin/bash -p gitpod gitpod \
...
RUN set -eux; \
	mkdir -p /home/gitpod/.local/share/docker; \
	chown -R gitpod:gitpod /home/gitpod/.local/share/docker
VOLUME /home/gitpod/.local/share/docker
